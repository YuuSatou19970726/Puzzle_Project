...
namespace Connect.Generator
{
    public class LevelGenerator : MonoBehaviour
    {
        ...
        {
            var board = Instantiate(_boardPrefab, new Vector3(levelSize / 2f, levelSize / 2f, 0f), Quaternion.identity);
        ...
        [SerializeField]
        private NodeRenderer _nodePrefab;
        ...
        [SerializeField]
        private GameObject _simulateButton;
                ...
                for (int j = 0; j < levelSize; j++)
                {
                    ...
                    if (currentColor != -1)
                    {
                        for (int p = 0; p < neighbourPoints.Length; p++)
                        {
                            ...
                            if (tempPoint.IsPointValid(levelSize) && grid[tempPoint.x, tempPoint.y] == currentColor)
                            {
